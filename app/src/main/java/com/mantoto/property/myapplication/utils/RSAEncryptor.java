...
public class RSAEncryptor {
 ...
 /*  public RSAEncryptor(String publicKeyFilePath, String privateKeyFilePath) throws Exception {
	...
	public RSAEncryptor(InputStream public_stream, InputStream private_stream) throws Exception {
	 	String public_key = getKeyFromStream(public_stream);
        String private_key = getKeyFromStream(private_stream);
        loadPublicKey(public_key);
        loadPrivateKey(private_key);
    }
	 ...
	 * @throws IOException
	 */
	private static String getKeyFromStream(InputStream in) throws IOException
	{
    ...
    public String getEncryptWithBase64(String string) throws Exception {
        byte[] binaryData = encrypt(getPublicKey(), string.getBytes());
        String base64String = new BASE64Encoder().encodeBuffer(binaryData) /* org.apache.commons.codec.binary.Base64.encodeBase64(binaryData) */;
        return base64String;
    }
    ...
    public void loadPublicKey(String publicKeyStr) throws Exception {
        try {
            ...
            Log.i("MyLog", "无此算法" + e.getMessage());
            throw new Exception("无此算法");
        } catch (InvalidKeySpecException e) {
            Log.i("MyLog", "公钥非法" + e.getMessage());
            throw new Exception("公钥非法");
        } catch (IOException e) {
            Log.i("MyLog", "公钥数据内容读取错误" + e.getMessage());
            throw new Exception("公钥数据内容读取错误");
        } catch (NullPointerException e) {
            Log.i("MyLog", "公钥数据为空" + e.getMessage());
    ...
    public void loadPrivateKey(InputStream in) throws Exception {
        try {
            ...
            Log.i("MyLog", "私钥数据读取错误" + e.getMessage());
            throw new Exception("私钥数据读取错误");
        } catch (NullPointerException e) {
            Log.i("MyLog", "私钥输入流为空" + e.getMessage());
    ...
    public void loadPrivateKey(String privateKeyStr) throws Exception {
        try {
            ...
            e.printStackTrace();
            Log.i("MyLog", "私钥非法" + e.getMessage());
            throw new Exception("私钥非法");
        } catch (IOException e) {
            Log.i("MyLog", "私钥数据内容读取错误" + e.getMessage());
            throw new Exception("私钥数据内容读取错误");
        } catch (NullPointerException e) {
            Log.i("MyLog", "私钥数据为空" + e.getMessage());
    ...
    public byte[] encrypt(RSAPublicKey publicKey, byte[] plainTextData) throws Exception {
        ...
        try {
            ...
            Log.i("MyLog", "无此加密算法" + e.getMessage());
            throw new Exception("无此加密算法");
        } catch (NoSuchPaddingException e) {
            e.printStackTrace();
            return null;
        } catch (InvalidKeyException e) {
            Log.i("MyLog", "加密公钥非法,请检查" + e.getMessage());
            throw new Exception("加密公钥非法,请检查");
        } catch (IllegalBlockSizeException e) {
            Log.i("MyLog", "明文长度非法" + e.getMessage());
            throw new Exception("明文长度非法");
        } catch (BadPaddingException e) {
            Log.i("MyLog", "明文数据已损坏" + e.getMessage());
    ...
    public byte[] decrypt(RSAPrivateKey privateKey, byte[] cipherData) throws Exception {
        ...
        try {
            ...
            Log.i("MyLog", "无此解密算法" + e.getMessage());
            throw new Exception("无此解密算法");
        } catch (NoSuchPaddingException e) {
            e.printStackTrace();
            return null;
        } catch (InvalidKeyException e) {
            Log.i("MyLog", "解密私钥非法,请检查" + e.getMessage());
            throw new Exception("解密私钥非法,请检查");
        } catch (IllegalBlockSizeException e) {
            Log.i("MyLog", "密文长度非法" + e.getMessage());
            throw new Exception("密文长度非法");
        } catch (BadPaddingException e) {
            Log.i("MyLog", "密文数据已损坏" + e.getMessage());
